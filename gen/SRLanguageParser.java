...
public class SRLanguageParser extends Parser {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"invocation", "sequential", "op_invocation", "op_service", "in_cmd", 
			"resource_control", "t", "basic_type", "enum_def", "pointer_def", "record_def", 
			"union_def", "capability_def", "cap_for", "prototype", "op_prototype", 
			"op_res", "result_id", "type_res", "parameters", "parameters2", "expression", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'ni'", "'call'", "'fa'", "'af'", "'('", "')'", "'['", "']'", "','", 
			"'inital'", "'const'", "'returns'", "'return'", "'to'", "'downto'", "'final'", 
			"'op'", "'do'", "'od'", "'proc'", "'co'", "'oc'", "'cap'", "'send'", 
			"'destroy'", "'begin'", "'receive'", "'create'", "'optype'", "'by'", 
			"'st'", "'type'", "'null'", "'bool'", "'val'", "'res'", "'ref'", "'exit'", 
			"'next'", "'file'", "'private'", "'or'", "'index'", "'mod'", "'stop'", 
			"'procedure'", "'and'", "'real'", "'on'", "'row'", "'true'", "'sender'", 
			"'left'", "'up'", "'abort'", "'reply'", "'process'", "'char'", "'string'", 
			"'false'", "'low'", "'high'", "'new'", "'enum'", "'any'", "'rec'", "'ptr'", 
			"'union'", "'vm'", "'sem'", "'xor'", "'skip'", "'forward'", "'separate'", 
			"'write'", "'V'", "'P'", "'->'", null, "'[]'", "'{'", "'}'", "':='", 
			"':=:'", "'++'", "'--'", "'<<'", "'>>'", "'!'", "'.'", "':'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"AND", "REAL", "ON", "ROW", "TRUE", "SENDER", "LEFT", "UP", "ABORT", 
			"REPLY", "PROCESS", "CHAR", "STRING", "FALSE", "LOW", "HIGH", "NEW", 
			"ENUM", "ANY", "REC", "PTR", "UNION", "VM", "SEM", "XOR", "SKP", "FORWARD", 
			"SEPARATE", "WRITE", "V", "P", "EJECUTA", "NUM", "SEPARA", "LBRACE", 
			"RBRACE", "ASIGNACION", "SWAP", "INCREMENTO", "DECREMENTO", "DESPLAZAR_IZQ", 
			"DESPLAZAR_DER", "EXCLAMACION", "PUNTO", "DOSPUNTOS", "AUG", "OPERADOR_ARITMETICO", 
			"OPERADOR_COMPARACION", "CADENA", "ESP", "LINE_COMMENT", "ID"
		};
	}
	...
	public static class OperationContext extends ParserRuleContext {
		...
		public List<TerminalNode> DOSPUNTOS() { return getTokens(SRLanguageParser.DOSPUNTOS); }
		public TerminalNode DOSPUNTOS(int i) {
			return getToken(SRLanguageParser.DOSPUNTOS, i);
		}
		public List<TerminalNode> ID() { return getTokens(SRLanguageParser.ID); }
		public TerminalNode ID(int i) {
			return getToken(SRLanguageParser.ID, i);
